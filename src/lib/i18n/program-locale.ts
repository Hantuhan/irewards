...
> = {
  ...
  2: {
    ...
    perk: { en: "Free topping upgrade", zh: "免费加料升级", ms: "Naik taraf topping percuma" },
  },
  3: {
    name: { en: "Silver", zh: "白银", ms: "Perak" },
    perk: { en: "Birthday drink", zh: "生日饮品", ms: "Minuman hari jadi" },
  },
  4: {
    name: { en: "Gold", zh: "黄金", ms: "Emas" },
    perk: { en: "Priority queue", zh: "优先排队", ms: "Barisan keutamaan" },
  },
  5: {
...
const ADMIN_COPY: Record<ProgramLanguage, RewardsAdminCopy> = {
  en: {
    ...
    copilotSubtitle: "A suggested earn & redeem setup for your café",
    earnLabel: "Earn rate",
    redeemLabel: "Redeem example",
    whyTitle: "Why this works",
    tierRatesTitle: "Points per RM by tier",
    redemptionTitle: "What members can redeem",
    applySetup: "Use this setup",
    higherEarn: "More generous earn",
    lowerEarn: "Lower earn (protect margin)",
    ptsPerRm: "pts per RM 1",
    ptsEquals: "pts =",
    programLanguage: "Program language",
    programLanguageHint: "Edit tier names and perks shown to diners in each language.",
    tierName: "Tier name",
    tierPerk: "Member perk",
    editingIn: "Editing in",
  },
  zh: {
    copilotTitle: "方案助手",
    copilotSubtitle: "为您的咖啡馆推荐的积分赚取与兑换设置",
    earnLabel: "赚取比例",
    redeemLabel: "兑换示例",
    whyTitle: "为什么推荐",
  ...
  ms: {
    ...
    copilotSubtitle: "Cadangan kadar mata & tebusan untuk kafe anda",
